...
public class AccueilGUI {
	...
	private int nbBot;
	private String mode2jeu = GameConfiguration.CARTE_VISIBLE;
	...
	public void app_run(){
		...
		//Label du titre
		JLabel jlJeuDeCartes = new JLabel("JEU DE CARTES");
        ...
        jbMoins.setBounds(284, 170, 50, 40);
        ...
        jbPlus.setBounds(391, 170, 50, 40);
